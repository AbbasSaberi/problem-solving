...
def main():
    ...
    c.draw(win) # Pause to view result
...
# # #     Number_of_obstacles = int(input('number of obstacles : '))
# # #     List = [] 
# # #     for Number in range(1 , Number_of_obstacles + 1):
# # #         obstacles = list(input())
...
# # #     c1 = Circle(Point(int(point1[0]) * 20, 800 - int(point1[1]) * 20) , 5)
# # #     c1.setFill('green')
# # #     c1.setOutline('green')
# # #     c1.draw(win)

# # #     c2 = Circle(Point(int(point2[0]) * 20, 800 - int(point2[1]) * 20) , 5)
# # #     c2.setFill('orange')
# # #     c2.setOutline('orange')
# # #     c2.draw(win)
...
#     ]
#     for points in a:
#         b = list(map(lambda x:Line(Point(points[x][0] * scale,(points[x][1] * scale, Point(points[x+1][0]) * scale,(points[x+1][1]) * scale)),range(len(points) - 2))))
#         for e in b:
#             e.draw(win)
#     win.getMouse()
#     win.close()
